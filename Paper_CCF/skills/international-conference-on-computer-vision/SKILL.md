...
description: Use when targeting IEEE/CVF International Conference on Computer Vision (ICCV) or deciding whether a computer-science manuscript fits this venue. Encodes conference fit, framing, evidence bar, submission-cycle checks, rebuttal posture, and desk-reject risks for computer vision flagship.
---
