...
本文件是 `de-aigc-skills` 的中文模式库（英文模式见 `patterns-en.md`）。按严重度分级（🔴 高 / 🟡 中 / 🟢 低）标注每条规则的触发风险。
...
**必须修复（🔴）**：ZH01, ZH04, ZH06, ZH10, ZH11, ZH12, ZH17
**建议修复（🟡）**：ZH02, ZH03, ZH07, ZH08, ZH13, ZH14
**可选修复（🟢）**：ZH05, ZH09, ZH15, ZH16
...
| 中文 AI 检测器 | 主要敏感模式 |
|--------------|-----------|
| 知网 AMLC | ZH01（四字套话）、ZH12（绝对化）、ZH06（句长方差）|
| 万方检测 | ZH04（连接词）、ZH07（模糊主语）、ZH10（总分总）|
| 维普通达 | ZH01、ZH03（AI 形容词）、ZH14（缺 hedge）|
| Turnitin 中文版 | ZH06（句长）、ZH13（观点-证据分离）、ZH11（序数词）|
| GPTZero 中文 | ZH06（句长方差）、ZH17（回音壁）|
