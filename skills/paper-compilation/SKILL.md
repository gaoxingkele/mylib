...
### Compile paper
```bash
python ~/.codex/skills/paper-compilation/scripts/compile_paper.py paper/main.tex
python ~/.codex/skills/paper-compilation/scripts/compile_paper.py paper/main.tex --check-style
python ~/.codex/skills/paper-compilation/scripts/compile_paper.py paper/main.tex --output paper/output.pdf
```
...
```bash
python ~/.codex/skills/paper-compilation/scripts/fix_latex_errors.py \
...
```bash
python ~/.codex/skills/paper-compilation/scripts/compile_paper.py paper/main.tex --auto-fix
```
...
## Related Skills
- Upstream: [citation-management](../citation-management/); optional LaTeX-formatting, figure-generation, and table-generation capabilities when installed.
- Optional downstream capabilities: self-review and paper assembly.
