...
ACM International Joint Conference on Pervasive and Ubiquitous Computing (UbiComp) is a top computer-science conference venue for pervasive computing, sensing, mobile/wearable systems, context awareness, and real-world deployments. It rewards a ubiquitous-computing paper with deployed sensing evidence or field-valid interaction data. Treat this skill as a **fit / venue-selection / re-framing** tool for conference submission strategy, not as a substitute for the current year's CFP, author kit, ethics policy, or submission portal.

Because CS conferences change deadlines, templates, page limits, review workflow, artifact rules, AI-use policy, and rebuttal formats every cycle, always verify the live official instructions before making a submission-ready recommendation. Start from the official source anchor recorded for this venue in `../../resources/conference-roster.md` and `../../resources/official-source-map.md`.

## When to trigger

- The author names UbiComp / ACM International Joint Conference on Pervasive and Ubiquitous Computing as the target venue.
- A manuscript in pervasive computing needs a conference-fit read before being formatted or submitted.
- The paper must be re-framed from journal style or arXiv style into a selective CS conference narrative.
- The author needs an evidence-gap, anonymity, artifact, rebuttal, or re-routing diagnosis for this venue.

## Scope & topic fit

- Core fit: pervasive computing, sensing, mobile/wearable systems, context awareness, and real-world deployments.
- Best submissions make a precise contribution type visible: algorithm, theorem, system, dataset, benchmark, empirical finding, design artifact, tool, or socio-technical analysis.
- The paper should explain why the result matters to UbiComp's reviewers, not just why it is interesting to the authors' lab or product context.
- Position related work against the most recent conference-cycle papers in this venue and its closest siblings; stale comparisons are a common early-review weakness.
- If the contribution is interdisciplinary, state which part is CS research and which part is domain evidence.

## Venue-specific calibration

- Reviewer lens: Treat UbiComp as a ubiquitous computing venue whose reviewers expect the scope and evidence to match its own community. Do not submit a generic CS paper until the introduction names the exact subcommunity, contribution type, and proof or empirical standard.
- Contribution hook to foreground: the venue-specific contribution bar.
- Scope vocabulary to use naturally in the abstract and introduction: pervasive computing, sensing, mobile/wearable systems, context awareness, and real-world deployments.
- Distinctive fingerprint for reviewer calibration: pervasive, computing, sensing, mobile, wearable, context, awareness, real-world, deployments, venue-specific, contribution, ubiquitous, ubicomp.
- Official anchor domain: www.ubicomp.org. Quote annual rules only after opening that source and the current-year CFP/author kit.

## Close-neighbor routing guardrail

- Use this profile only when the manuscript's central contribution is genuinely in ubiquitous
  computing and the author can say why UbiComp reviewers are the primary audience, not merely
...
- Closest roster neighbors to compare before final routing: `acm-conference-on-computer-
  ...
  user-interfaces` (IUI), `acm-international-conference-on-mobile-human-computer-interaction`
  (MobileHCI), `acm-international-conference-on-tangible-embedded-and-embodied-interaction`
...
- For UbiComp, the evidence must support the venue-specific signature: a ubiquitous-computing paper with deployed sensing evidence or field-valid interaction data.
...
- Open the live official venue page: https://www.ubicomp.org/
...
- [ ] One sentence states why this manuscript belongs at UbiComp, using the venue's scope rather than generic "top conference" language.
- [ ] The claim is calibrated to the evidence: no broader than the datasets, proofs, systems, user studies, deployments, or threat model support.
- [ ] Related work includes the nearest current-cycle ubiquitous computing papers and explains the technical delta.
